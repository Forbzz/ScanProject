...
final class DecodeFormatManager {
  ...
  static final Set<BarcodeFormat> CODE128_CODE_FORMATS = EnumSet.of(BarcodeFormat.CODE_128);
  ...
  static {
    ...
    FORMATS_FOR_MODE.put(Intents.Scan.QR_CODE_MODE, CODE128_CODE_FORMATS);
